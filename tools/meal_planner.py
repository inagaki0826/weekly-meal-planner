...
def replace_meal(day: str, current_meals: list) -> tuple:
...
"""
    ...
    new_shopping = _rebuild_shopping(updated_meals)
    return new_meal, new_shopping


def _rebuild_shopping(meals: list) -> list:
    meal_text = "\n".join([
